...
#include <memory>
#include "../../../gui_sources/labelimage.h"
...
QT_MOC_LITERAL(1, 11, 16), // "SignalPressedPos"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 13) // "SignalMovePos"

    },
    "LabelImage\0SignalPressedPos\0\0SignalMovePos"
};
...
void LabelImage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SignalPressedPos((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->SignalMovePos((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LabelImage::SignalPressedPos)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LabelImage::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LabelImage::SignalMovePos)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LabelImage::staticMetaObject = { {
    QMetaObject::SuperData::link<AdjustableLabel::staticMetaObject>(),
...
void *LabelImage::qt_metacast(const char *_clname)
{
    ...
    return AdjustableLabel::qt_metacast(_clname);
}

int LabelImage::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = AdjustableLabel::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 2)
...
// SIGNAL 0
void LabelImage::SignalPressedPos(int _t1, int _t2)
{
...
// SIGNAL 1
void LabelImage::SignalMovePos(int _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };

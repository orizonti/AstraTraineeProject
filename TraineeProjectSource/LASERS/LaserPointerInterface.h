...
class LaserPointerInterface : public LaserCommonInterface
{
	Q_OBJECT
private:
...
public:
	LaserPointerInterface();
    LaserPointerInterface(QString PortName);
    LaserPointerInterface(LaserPointerInterface& CopyInterface);

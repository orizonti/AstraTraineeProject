...
QPair<double, double> PassTwoCoordClass::GetCoord() { return QPair<double, double>(0, 0); }
PassTwoCoordClass& operator >>(PassTwoCoordClass& Sender, PassTwoCoordClass& Reciever) { Reciever.SetCoord(Sender.GetCoord()); return Reciever; }
PassTwoCoordClass& operator >>(PassTwoCoordClass& Sender, QPair<double,double>& Coord) { Coord = Sender.GetCoord(); return Sender; }
PassTwoCoordClass& operator >>(QPair<double, double> Coord, PassTwoCoordClass& Reciever) { Reciever.SetCoord(Coord); return Reciever; }
